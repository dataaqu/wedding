      ...
      <div className="flex flex-col items-center w-full max-w-[700px] mt-20">
        ...
        <div className="relative w-full -mt-56 md:-mt-72" style={{ height: '90vw', maxHeight: '600px' }}>
          ...
          <motion.div
            ...
            className="absolute left-[5%] top-[20%] w-[20%] z-30 will-change-transform"
          >
            <Image
          ...
          <motion.div
            ...
            className="absolute left-[-10%] top-[5%] w-[85%] z-40 will-change-transform"
          >
            <Image
          ...
          <motion.div
            ...
            className="absolute right-[25%] md:right-[20%] top-[25%] md:top-[10%] w-[22%] z-30 will-change-transform"
          >
            <Image
          ...
          <motion.div
            ...
            className="absolute right-[12%] top-[30%] w-[15%] z-30 rotate-[10deg] will-change-transform"
          >
            <Image
          ...
          <motion.div
            ...
            className="absolute left-[70%] top-[60%] w-[10%] z-30 will-change-transform"
          >
            <Image
          ...
          <motion.div
            ...
            className="absolute right-[15%] top-[75%] w-[15%] z-30 will-change-transform"
          >
            <Image
